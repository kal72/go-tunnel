...
- **Categorization & Filtering Rules**:
  ...
  - **CI/CD & Tooling Exclusions**: **DO NOT** record CI/CD (`ci`), GitHub Actions workflows, automated build pipeline adjustments, or internal automation scripts in `CHANGELOG.md`. Keep the changelog strictly focused on user-facing and architectural changes.
