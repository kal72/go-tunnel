...
\____/\____//_/  \__,_/_/ /_/_/ /_/\___/   `
		...
		fmt.Fprintf(os.Stderr, "  gotunnel [command]\n\n")
		...
		fmt.Fprintf(os.Stderr, "  RDP (Windows Remote Desktop), database server, etc.:\n")
		...
		fmt.Fprintf(os.Stderr, "\033[1mUsage:\033[0m\n")
		fmt.Fprintf(os.Stderr, "  gotunnel [options]\n\n")
	...
	case "forward":
		...
		stop()
		if runErr != nil {
			log.Printf("Forward error: %v", runErr)
			os.Exit(1)
		}
