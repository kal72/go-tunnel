...
func (r *sqlxUserRepository) GetUserByUsername(ctx context.Context, username string) (*User, error) {
	var user User
...
func (r *sqlxUserRepository) CreateUser(ctx context.Context, user *User) error {
...
func (r *sqlxUserRepository) GetUsers(ctx context.Context) ([]User, error) {
	var users []User
