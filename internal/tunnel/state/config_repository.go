...
func (r *sqlxConfigRepository) GetConfigByName(ctx context.Context, userID uuid.UUID, name string) (*ClientConfig, error) {
...
func (r *sqlxConfigRepository) GetConfigByID(ctx context.Context, id uuid.UUID) (*ClientConfig, error) {
	var cfg ClientConfig
...
func (r *sqlxConfigRepository) GetConfigsByUserID(ctx context.Context, userID uuid.UUID) ([]ClientConfig, error) {
...
func (r *sqlxConfigRepository) GetAllConfigs(ctx context.Context) ([]ClientConfig, error) {
	var configs []ClientConfig
...
func (r *sqlxConfigRepository) CreateConfig(ctx context.Context, cfg *ClientConfig) error {
...
func (r *sqlxConfigRepository) UpdateConfig(ctx context.Context, cfg *ClientConfig) error {
