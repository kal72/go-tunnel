...
func New(fs embed.FS, tunnelUsecase usecase.TunnelUsecase, configUsecase usecase.ConfigUsecase, masterSecret string, tunnelAddr string, wildcardDomain string, gatewayHost string, acmeEnable bool) *Handler {
...
func (h *Handler) CreateConfig(w http.ResponseWriter, r *http.Request) {
	var payload model.ClientConfig
